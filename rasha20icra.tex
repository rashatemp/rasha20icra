...
%\end{figure}
    ...
    \begin{figure}
    \centering
    \includegraphics[width=0.32\linewidth]{pics/bonn/images/1462264412_672341082.png}
    \includegraphics[width=0.32\linewidth]{pics/stuttgart/images/masks_8mm_fromImages_frame757.png}
    \includegraphics[width=0.32\linewidth]{pics/zurich/images/bonirob_2016-10-13-09-03-00_0_frame70.png}\\[1mm]
    \includegraphics[width=0.32\linewidth]{pics/bonn/annotations/1462264412_672341082.png}
    \includegraphics[width=0.32\linewidth]{pics/stuttgart/annotations/masks_8mm_fromImages_frame757_GroundTruth_iMap.png}
    \includegraphics[width=0.32\linewidth]{pics/zurich/annotations/bonirob_2016-10-13-09-03-00_0_frame70.png}
    \caption{Sample images from the Bonn, Stuttgart, and Zurich
      sugar beet datasets in the first, second, and third column,
      respectively. The first row shows the RGB images and the second
      row shows their annotations~(green denotes crop while red
