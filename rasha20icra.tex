...
In this section, we describe four different approach to sample selection for active learning based on uncertainty (\secref{ssec:unc}), loss (\secref{ssec:loss}), and gradients (\secref{ssec:normgrad} and \secref{ssec:gradproj}).
