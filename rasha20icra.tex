...
Tables~\ref{tab:object_wise_stuttgart} and \ref{tab:object_wise_zurich} shows how our approach performs on the Stuttgart and Zurich datasets. Each row shows the mean accuracy when selecting $n$ samples with different methods. For comparison, random and entropy based sampling are shown in the first and second columns respectively.
