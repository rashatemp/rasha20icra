...
%these training samples will have on the weight gradients of the CNN. 
...
The works mentioned previously and the current state-of-the-art methods for active learning including ~\cite{gal2017deep}, \cite{beluch2018power}, \cite{sener2017active}, and \cite{yoo2019learning} are either more suitable for tasks other than pixel-wise semantic segmentation of images with CNNs and/or are memory and computationally expensive.
