...
We follow the approach described in~\cite{milioto2018real} for splitting the new data  for training, validation, and  testing. All experiments were conducted on four Nvidia Titan~X GPUs.  \todo{Do we need to comment on the runtime of retraining? Otherwise mentioning the GPU does not make much sense, right?}
...
\todo{This next paragraph is hard to understand}
